...
/*--------------------------------------------------------------------------*/
  ...
  /*--------------------------------------------------------------------------*/
  /* Step 2:                                                                  */
  /* Set Port_SetToAlternateMode and Port_SetToDioMode. */
  ...
  /* Check valid register. */
  /*--------------------------------------------------------------------------*/
  AES_TEST_ASSERT(((GPSR0 & 0x0003) == 0x0001) 
    && ((IOINTSEL0 & 0x0002) == 0x00000));
  /*--------------------------------------------------------------------------*/
  /* Step 3:                                                                  */
  /* Set valid register. */
  ...
  /*--------------------------------------------------------------------------*/
  AES_TEST_ASSERT(((GPSR0 & 0x0003) == 0x0001));
  AES_TEST_ASSERT((RFSO3 & 0x0006) == 0x0002);
  AES_Report_Result();
}
