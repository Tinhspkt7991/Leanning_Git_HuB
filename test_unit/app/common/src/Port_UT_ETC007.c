...
/*--------------------------------------------------------------------------*/
  ...
  /*--------------------------------------------------------------------------*/
  AES_TEST_ASSERT((IPSR6 & 0xF000) == 0x0000);
  ...
  /*                                                                          */
  /*--------------------------------------------------------------------------*/
  Port_SetPinMode(Port_PortGroup0_PortPin0, APP_ALT1);
  Port_SetPinMode(Port_PortGroup0_PortPin8, APP_ALT4);
  Port_SetPinMode(Port_PortGroup0_PortPin10, APP_ALT5);
  /*--------------------------------------------------------------------------*/
  /* Step 4:                                                                  */
