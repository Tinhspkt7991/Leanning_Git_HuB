...
/*--------------------------------------------------------------------------*/
  ...
  /* Step 5:                                                                  */
  /* Set valid register. */
  PMMR = ~(GPSR0 &= ~(uint32)0x3);GPSR0 &= ~(uint32)0x3;
  ...
  /*                                                                          */
  /*--------------------------------------------------------------------------*/
  AES_TEST_ASSERT(((GPSR0 & 0x0003) == 0x0003) &&((IPSR5 & 0xF0000) == 0x0000)
    &&((MOD_SEL0 & 0x18000000) == 0x8000000));
  AES_TEST_ASSERT((RFSO1 & 0x0006) == 0x0002);
  AES_Report_Result();
}
