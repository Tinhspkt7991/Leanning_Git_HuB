...
/*--------------------------------------------------------------------------*/
  ...
  /*                                                                          */
  /*--------------------------------------------------------------------------*/
  PMMR = ~(GPSR0 |= 0x0F); GPSR0 |= 0x0F; IOINTSEL0 |=0x0F;
  PMMR = ~(GPSR1 &= ~(uint32)0x0F); GPSR1 &= ~(uint32)0x0F; 
  PMMR = ~(GPSR2 |= 0x0F); GPSR2 |= 0x0F; IOINTSEL2 |=0x0F; 
  /*--------------------------------------------------------------------------*/
  /* Step 3:                                                                  */
  ...
  Port_SetPinDefaultMode(Port_PortGroup1_PortPin1);
  Port_SetPinDefaultMode(Port_PortGroup1_PortPin2);
  Port_SetPinDefaultMode(Port_PortGroup1_PortPin3);
  ...
  Port_SetPinDefaultMode(Port_PortGroup2_PortPin3);
  /*--------------------------------------------------------------------------*/
  /* Step 4:                                                                  */
