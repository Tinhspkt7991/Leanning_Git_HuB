...
/*--------------------------------------------------------------------------*/
  ...
  Port_SetPinDirection(Port_PortGroup3_PortPin0, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin1, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin2, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin3, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin4, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin5, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin6, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin7, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin8, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin9, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin10, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin11, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin12, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin13, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin14, PORT_PIN_OUT);
  Port_SetPinDirection(Port_PortGroup3_PortPin15, PORT_PIN_OUT);
  /*--------------------------------------------------------------------------*/
  /* Step 3:                                                                  */
  /* Check AES_TEST_ASSERT() will be invoked with the parameters              */
  /*                                                                          */
  /*--------------------------------------------------------------------------*/
  AES_TEST_ASSERT(((OUTDT0 & 0xFFFF) == 0x7FF)
