...
int main(void)
{
 ...
 AES_TEST_ASSERT(((GPSR2 & 0x0004) == 0x0004)
   ...
   //IRQ0   IRQ1   IRQ2 SD0_DAT2
  Port_SetPinMode(Port_PortGroup3_PortPin4, APP_ALT5);   
 ...
 AES_TEST_ASSERT(((GPSR3 & 0x0010) == 0x0010)
  ...
  Port_SetPinMode(Port_PortGroup3_PortPin5, APP_ALT5);   
 ...
 AES_TEST_ASSERT(((GPSR3 & 0x0020) == 0x0020)
  ...
  Port_SetPinMode(Port_PortGroup3_PortPin6, APP_ALT5);   
 ...
 AES_TEST_ASSERT(((GPSR3 & 0x0040) == 0x0040)
  ...
  Port_SetPinMode(Port_PortGroup3_PortPin7, APP_ALT5);   
 ...
 AES_TEST_ASSERT(((GPSR5 & 0x0002) == 0x0002)
  ...
  Port_SetPinMode(Port_PortGroup5_PortPin1, APP_ALT7);   
  /* Check the GPSR,IPSR, MODSEL PortGroup5 for PortPin 1 */
 AES_TEST_ASSERT(((GPSR5 & 0x0002) == 0x0002)
 ...
 AES_TEST_ASSERT(((GPSR5 & 0x0004) == 0x0004)
  ...
  Port_SetPinMode(Port_PortGroup5_PortPin2, APP_ALT7);   
  /* Check the GPSR,IPSR, MODSEL PortGroup5 for PortPin 2 */
 AES_TEST_ASSERT(((GPSR5 & 0x0004) == 0x0004)
  ...
  AES_TEST_ASSERT(((GPSR1 & 0x0001) == 0x0001) && ((GPSR2 & 0x0007) == 0x0007) 
    && ((GPSR3 & 0x00F0) == 0x00F0) && ((GPSR5 & 0x0007) == 0x0007));  
  AES_TEST_ASSERT(((IPSR1 & 0xF000000F) == 0x60000009)  
    && ((IPSR11 & 0xFF000000) == 0x7A000000) 
      && ((IPSR0 & 0xFF000000) == 0x66000000) && ((IPSR8 & 0xFFFF) == 0x6566)   
        && ((IPSR12 & 0x000F) == 0x0007)); 
  AES_TEST_ASSERT(((MOD_SEL0 & 0xE72100E0)== 0x21010060)
    && ((MOD_SEL1 & 0x3BE60044) == 0x9200044)
         && ((MOD_SEL2 & 0x4020001) == 0x4020001)); 
 AES_Report_Result();
}
